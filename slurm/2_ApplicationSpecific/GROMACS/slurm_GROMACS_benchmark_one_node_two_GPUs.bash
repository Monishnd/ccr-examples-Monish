...
## one node, 16 cores, two GPUs
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=16
#SBATCH --gpus-per-node=2
#SBATCH --job-name=gmx-1n-2GPU
...
then
  ...
  echo "No GPU allocated - bailing" >&2
  exit 1
fi
echo
...
#echo "ompi_info --param btl all"
#ompi_info --param btl all
#echo

## Environment variables for OpenMPI over Ethernet
export OMPI_MCA_pml=ob1 && export OMPI_MCA_btl="self,vader,tcp"

### Environment variables for PMIx (srun --mpi=pmix [...])
