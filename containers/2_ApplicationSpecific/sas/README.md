...
A Slurm script [`sas-test.bash`](./sas-test.bash) is provided with all necessary configuration for running SAS in a bash script. Update the file paths, resource requests, and SAS options according to your needs.
