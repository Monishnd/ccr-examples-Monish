...
Here we present a minimalist example of container usage on the CCR's HPC environment. Python is used as an example due to it being a common software that benefits from containerization.
